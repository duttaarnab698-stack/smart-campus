...
class Settings:
    ...
    allowed_origins: tuple[str, ...] = tuple(dict.fromkeys([value.strip() for value in os.getenv("FRONTEND_ORIGINS", os.getenv("ALLOWED_ORIGINS", "http://127.0.0.1:5500,http://localhost:5500")).split(",") if value.strip()] + ["https://smart-campus-nyql.vercel.app", "https://smart-campus-red.vercel.app"]))
